...
public class PmWlgController {
	...
	static {
		...
		sortTypes.put("pmNum", "pmnum");
	}

	@Autowired
	private PmWlgService pmWlgService;
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<PmWlg> pmWlgs = pmWlgService.getUserPmWlg(searchParams, pageNumber, pageSize, sortType);
	...
	public String createForm(Model model) {
		model.addAttribute("pmWlg", new PmWlg());
		model.addAttribute("action", "create");
		return "pmWlg/pmWlgForm";
	}

	@RequestMapping(value = "create", method = RequestMethod.POST)
	public String create(@Valid PmWlg newpmWlg, RedirectAttributes redirectAttributes) {
	...
	public String update(@Valid @ModelAttribute("pmWlg") PmWlg pmWlg, RedirectAttributes redirectAttributes) {
